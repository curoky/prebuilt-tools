...
| `dive` | 📌 `25.11` | 📌 `25.11` native | ✅ | 两平台都 pin `25.11`；macOS 使用已只依赖系统库的 native CGO build | 两个平台分别用 unstable 并满足 portability | `manifests/default.nix` |
...
| `fzf` | — | 📌 `25.11` native | ✅ | macOS pin 到 native pkgs；CGO build 已只依赖系统库，强关 CGO 会触发 disallowed reference | unstable native 产物只依赖系统 dylib | `manifests/default.nix` |
| `gdb` | 📌 `25.11` | 📌 `25.11` | ✅ | 历史 pin，原始失败未记录 | unstable 在两平台构建并满足 portability | `manifests/default.nix` |
| `gdu` | — | 📌 `25.11` native | ✅ | macOS pin 到 native pkgs；CGO build 已只依赖系统库，强关 CGO 会触发 disallowed reference | unstable native 产物只依赖系统 dylib | `manifests/default.nix` |
| `gettext` | 🩹 本地 | 🩹 本地 | ✅ | 强制使用 bundled gettext/libintl | stock unstable 静态构建可搬运时删除 override | `packages/gettext/` |
| `gh` | — | 📌 `25.11` native | ✅ | macOS pin 到 native pkgs；CGO build 已只依赖系统库，强关 CGO 会触发 disallowed reference | unstable native 产物只依赖系统 dylib | `manifests/default.nix` |
...
| `lefthook` | — | 📌 `25.11` native | ✅ | macOS pin 到 native pkgs；CGO build 已只依赖系统库，强关 CGO 会触发 disallowed reference | unstable native 产物只依赖系统 dylib | `manifests/default.nix` |
...
| `oras` | — | 📌 `25.11` native | ✅ | macOS pin 到 native pkgs；CGO build 已只依赖系统库，强关 CGO 会触发 disallowed reference | unstable native 产物只依赖系统 dylib | `manifests/default.nix` |
...
| `scc` | — | 📌 `25.11` native | ✅ | macOS pin 到 native pkgs；CGO build 已只依赖系统库，强关 CGO 会触发 disallowed reference | unstable native 产物只依赖系统 dylib | `manifests/default.nix` |
| `shellcheck` | — | 📌 `25.11` | ✅ | 历史 pin，原始失败未记录 | unstable 产物只依赖系统 dylib | `manifests/default.nix` |
| `shfmt` | — | 📌 `25.11` native | ✅ | macOS pin 到 native pkgs；CGO build 已只依赖系统库，强关 CGO 会触发 disallowed reference | unstable native 产物只依赖系统 dylib | `manifests/default.nix` |
