...
| `bazelisk` | — | 📌 `25.11` + 🩹 CGO | ✅ | `pkgs2511` 并设 `CGO_ENABLED=0` 以消除 Nix dylib | unstable 默认产物只依赖系统 dylib | `packages/local.nix` |
| `buildifier` | — | 📌 `25.11` + 🩹 CGO | ✅ | `pkgs2511` 并设 `CGO_ENABLED=0` 以消除 Nix dylib | unstable 默认产物只依赖系统 dylib | `packages/local.nix` |
...
| `croc` | — | 📌 `25.11` + 🩹 CGO | ✅ | `pkgs2511` 并设 `CGO_ENABLED=0` 以消除 Nix dylib | unstable 默认产物只依赖系统 dylib | `packages/local.nix` |
...
| `diffutils` | 🩹 本地 | 🩹 本地 | ✅ | 仅禁用 stock checks，具体失败未记录 | unstable 全量 checks 与 portability 验证通过 | `packages/diffutils/` |
| `dive` | 📌 `25.11` | 📌 `25.11` + 🩹 CGO | ✅ | Linux 为 manifest pin；macOS 另设无 CGO 以消除 Nix dylib | 两个平台分别用 unstable 并满足 portability | `manifests/default.nix`, `packages/local.nix` |
...
| `fzf` | — | 📌 `25.11` + 🩹 CGO | ✅ | `pkgs2511` 并设 `CGO_ENABLED=0` 以消除 Nix dylib | unstable 默认产物只依赖系统 dylib | `packages/local.nix` |
| `gdb` | 📌 `25.11` | 📌 `25.11` | ✅ | 历史 pin，原始失败未记录 | unstable 在两平台构建并满足 portability | `manifests/default.nix` |
| `gdu` | — | 📌 `25.11` + 🩹 CGO | ✅ | `pkgs2511` 并设 `CGO_ENABLED=0` 以消除 Nix dylib | unstable 默认产物只依赖系统 dylib | `packages/local.nix` |
| `gettext` | 🩹 本地 | 🩹 本地 | ✅ | 强制使用 bundled gettext/libintl | stock unstable 静态构建可搬运时删除 override | `packages/gettext/` |
| `gh` | — | 📌 `25.11` + 🩹 CGO | ✅ | `pkgs2511` 并设 `CGO_ENABLED=0` 以消除 Nix dylib | unstable 默认产物只依赖系统 dylib | `packages/local.nix` |
...
| `git-lfs` | — | 📌 `25.11` + 🩹 CGO | ✅ | `pkgs2511` 并设 `CGO_ENABLED=0` 以消除 Nix dylib | unstable 默认产物只依赖系统 dylib | `packages/local.nix` |
...
| `go-task` | — | 📌 `25.11` + 🩹 CGO | ✅ | `pkgs2511` 并设 `CGO_ENABLED=0` 以消除 Nix dylib | unstable 默认产物只依赖系统 dylib | `packages/local.nix` |
...
| `lark-cli` | — | 📦 平台 wiring | ❌ | 直接使用 unstable；关闭 CGO 反而产生 disallowed reference | 当前没有 pin 或 patch 可回归 | `packages/local.nix` |
| `lefthook` | — | 📌 `25.11` + 🩹 CGO | ✅ | `pkgs2511` 并设 `CGO_ENABLED=0` 以消除 Nix dylib | unstable 默认产物只依赖系统 dylib | `packages/local.nix` |
...
| `oras` | — | 📌 `25.11` + 🩹 CGO | ✅ | `pkgs2511` 并设 `CGO_ENABLED=0` 以消除 Nix dylib | unstable 默认产物只依赖系统 dylib | `packages/local.nix` |
...
| `patchelf` | 📌 `25.05` | 📌 `25.05` | ✅ | 历史 pin，原始失败未记录 | unstable 在两平台构建并满足 portability | `manifests/default.nix` |
...
| `protobuf3_20` | 📌 `24.05` | — | ✅ | 历史 pin，原始失败未记录 | unstable 构建为 musl-static standalone | `manifests/default.nix` |
| `protobuf3_21` | 📌 `24.05` | — | ✅ | 历史 pin，原始失败未记录 | unstable 构建为 musl-static standalone | `manifests/default.nix` |
| `protobuf_23` | 📌 `24.05` | — | ✅ | 历史 pin，原始失败未记录 | unstable 构建为 musl-static standalone | `manifests/default.nix` |
| `protobuf_24` | 📌 `25.05` | — | ✅ | 历史 pin，原始失败未记录 | unstable 构建为 musl-static standalone | `manifests/default.nix` |
| `protobuf_26` | 📌 `25.05` | — | ✅ | 历史 pin，原始失败未记录 | unstable 构建为 musl-static standalone | `manifests/default.nix` |
...
| `scc` | — | 📌 `25.11` + 🩹 CGO | ✅ | `pkgs2511` 并设 `CGO_ENABLED=0` 以消除 Nix dylib | unstable 默认产物只依赖系统 dylib | `packages/local.nix` |
| `shellcheck` | — | 📌 `25.11` | ✅ | 历史 pin，原始失败未记录 | unstable 产物只依赖系统 dylib | `manifests/default.nix` |
| `shfmt` | — | 📌 `25.11` + 🩹 CGO | ✅ | `pkgs2511` 并设 `CGO_ENABLED=0` 以消除 Nix dylib | unstable 默认产物只依赖系统 dylib | `packages/local.nix` |
